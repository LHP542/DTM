...
/// eines bestimmten <see cref="DbServer.ServerTyp"/>. Statischer Container,
...
{
    public DbServer.ServerTyp ServerTyp { get; }

    public ServerGroupNodeViewModel(DbServer.ServerTyp typ)
    {
        ServerTyp = typ;
        Header = typ.ToString();
